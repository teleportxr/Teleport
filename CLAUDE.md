...
## Indexing
- When you read a source directory that doesn't contain a CLAUDE.md, add one. Record your description of what the files are for, and how they relate to other parts of the source.