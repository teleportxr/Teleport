...
bool DefaultHTTPService::initialize(std::string mountDirectory, std::string certPath, std::string privateKeyPath, int32_t port)
{
	...
	{
		TELEPORT_INTERNAL_COUT(Default, "SSL certificate and key provided. Usng HTTPS server.");
	...
	{
		TELEPORT_INTERNAL_COUT(Default, "SSL certificate and key not provided. Usng HTTP server.");
